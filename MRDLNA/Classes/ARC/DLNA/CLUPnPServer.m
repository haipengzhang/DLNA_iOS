...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _queue = dispatch_queue_create("com.lzwk.upnp.dlna", DISPATCH_QUEUE_SERIAL);
...
{
    CLLog(@"airPlay-udpSocketError:%@", error);
    [self onError:error];
}

- (void)udpSocketDidClose:(GCDAsyncUdpSocket *)sock withError:(NSError * _Nullable)error
{
    CLLog(@"airPlay-udpSocket关闭:%@", error);
}
